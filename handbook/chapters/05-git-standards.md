...
- Content prohibited by the [security policy](21-security-policy.md) or [client data policy](22-client-data-policy.md) MUST NOT be committed, including in deleted history.
